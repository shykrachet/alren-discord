function formatHelp() {
  return [
    ...
    '',
    '**4. Community alerts**',
    '• An administrator uses `/community-alert-settings` to choose an alerts channel and BN mode.',
    '• New Mappers’ Guild missions always use that same configured channel.',
    '',
    '**Useful commands**',
    ...
    '`/community-alert-settings` — View or change BN and Mappers’ Guild alerts privately.',
